...
class CreditController extends AbstractController
{
    ...
    #[Route('/{idDemande}', name: 'app_credit_show', methods: ['GET'])]
    ...
    #[Route('/{idDemande}/edit', name: 'app_credit_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{idDemande}', name: 'app_credit_delete', methods: ['POST'])]
    public function delete(Request $request, Credit $credit, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$credit->getIdDemande(), $request->request->get('_token'))) {
