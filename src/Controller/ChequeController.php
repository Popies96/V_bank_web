...
class ChequeController extends AbstractController
{
    ...
    #[Route('/{numero_de_cheque}', name: 'app_cheque_show', methods: ['GET'])]
    ...
    #[Route('/{numero_de_cheque}/edit', name: 'app_cheque_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{numero_de_cheque}', name: 'app_cheque_delete', methods: ['POST'])]
