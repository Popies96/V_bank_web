...
class CompteController extends AbstractController
{
    ...
    #[Route('/{idCompte}', name: 'app_compte_show', methods: ['GET'])]
    ...
    #[Route('/{idCompte}/edit', name: 'app_compte_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{idCompte}', name: 'app_compte_delete', methods: ['POST'])]
