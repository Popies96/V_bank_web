...
class TransactionController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $fee = $this->calculateFee($montant);
            $totalAmount = $montant + $fee;

            $transaction->setMontant($totalAmount); // Update the montant with the total amount including the fee
    ...
    private function calculateFee(int $amount): int
    {
        ...
        return (int)($amount * $feePercentage);
    }
